...
public class BlogPostDAO {
    ...
    public void addPostComment(final String name, final String email, final String body,
        ...
        Document comment = o("author", name).append("email", email).append("body", body);
        postsCollection.updateOne(eq("permalink", permalink), o("$push", o("comments", comment)));
    }

    private static Document o(String key, Object value) {
